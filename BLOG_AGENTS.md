...
- **ΚΑΜΙΑ παύλα/em-dash (—) πουθενά**: τίτλος, excerpt, content. Χώρισε σε δύο προτάσεις με τελεία, ή χρησιμοποίησε κόμμα/άνω-κάτω τελεία. Ρητή οδηγία του Theo, έχει ξαναδιορθωθεί σε παλιά posts.
