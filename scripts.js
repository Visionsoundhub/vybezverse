document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- GLOBAL CLICK LISTENER FOR BUTTONS (FIXES STORE BUTTON) ---
    document.addEventListener('click', (e) => {
        // Fix for Store Bundle Button
        ...
        // Fix for Closing Modals on Overlay Click
    ...
    function initAllScripts() {
        ...
        // Bundle Modal List Logic (if needed)
    ...
    function updateMenuState() {
        ...
        document.querySelectorAll('.nav-btn').forEach(link => { const linkPath = link.getAttribute('href').split('/').pop(); if (linkPath === currentPath || (currentPath === '' && linkPath === 'index.html')) { link.classList.add('active'); } else { link.classList.remove('active'); } });
    }
    function restoreHeroArt() {
        const heroArt = document.getElementById('hero-beat-art'); const heroImg = document.getElementById('hero-beat-img');
    ...
    function checkPlayerVisibility() {
        ...
        const isBeatsPage = window.location.pathname.includes('beats.html'); const hasActiveTrack = audio.src && audio.src !== '' && window.location.href !== audio.src; 
