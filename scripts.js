document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderPopup() {
        ...
        // Αν ο χρήστης το έχει κλείσει, δεν το ξαναδείχνουμε
                    ...
                    if (data.storeActive === false) {
                        ...
                        beatCont.innerHTML = `
                            <div style="text-align:center; padding: 4rem 1rem; width:100%;">
                                <h2 style="font-size: 2rem; color: #8a2be2; margin-bottom: 1rem; text-shadow: 0 0 10px rgba(138,43,226,0.5);">${msg}</h2>
